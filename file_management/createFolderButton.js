const createFolderButton = (folderName, folderPath, selectedPathSetter) => {
    ...
    newFolderButton.innerHTML = `<svg class="folderSVG" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="2 2 10 10" fill="none" stroke="whitesmoke" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
